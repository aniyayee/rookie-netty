...
public class RpcClientManager {
    ...
    public static void main(String[] args) {
        // 创建代理对象
        HelloService service = (HelloService) getProxyService(HelloService.class);
        // 通过代理对象执行方法
        System.out.println(service.sayHello("yayee"));
        System.out.println(service.sayHello("Hulu"));
        System.out.println(service.sayHello("aniya"));
    }
